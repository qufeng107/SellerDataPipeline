...
from seller_data_pipeline.ingestion.fba_fee_preview_ingestion import (
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description=(
            "Run guarded SP-API FBA Fee Preview ingestion. "
    ...
    parser.add_argument(
        ...
        default=None,
        help=(
            "Optional explicit GET_FBA_ESTIMATED_FBA_FEES_TXT_DATA raw file. "
    ...
    service = FbaFeePreviewIngestionService(
    ...
    print(f"FBA Fee Preview ingestion mode={result.mode} status={result.status}")
