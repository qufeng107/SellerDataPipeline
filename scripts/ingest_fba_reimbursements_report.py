...
from seller_data_pipeline.ingestion.fba_reimbursements_ingestion import (
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description=(
            "Run guarded SP-API FBA Reimbursements ingestion. "
            "The default mode is dry-run only; "
    ...
    parser.add_argument(
        ...
        default=None,
        help=(
            "Optional explicit GET_FBA_REIMBURSEMENTS_DATA raw file. "
    ...
    service = FbaReimbursementsIngestionService(
    ...
    print(f"FBA Reimbursements ingestion mode={result.mode} status={result.status}")
