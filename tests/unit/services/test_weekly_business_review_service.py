...
def test_parse_week_start_accepts_explicit_period_start() -> None:
    ...
    assert parse_week_start("2026-04-11") == date(2026, 4, 11)
    try:
        parse_week_start("2026/04/11")
...
def test_run_uses_repo_and_writes_report(tmp_path: Path) -> None:
    ...
    assert result.output_files["xlsx"].endswith("weekly_business_review_2026-04-06_2026-04-12.xlsx")
