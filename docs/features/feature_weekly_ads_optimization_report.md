...
> **v2 redesign note (2026-08-16):** Default presentation and Ads attribution/action-window policy are superseded by `feature_weekly_reporting_pack_redesign.md` and ADR-017. Existing v1 details remain implementation/history reference until v2 rollout.
