...
| [`docs/features/feature_finances_api_natural_month_sampling.md`](docs/features/feature_finances_api_natural_month_sampling.md) | v1.89 Finances API v2024-06-19 read-only natural-month sampling；先与 Seller Central Monthly Transaction 对账，尚未切换 Management P&L。 |
