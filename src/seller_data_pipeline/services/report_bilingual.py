...
HEADER_ZH: dict[str, str] = {
    ...
    "unit_product_cost": "单位商品成本",
    "unit_first_mile_cost": "单位头程成本",
    "unit_packaging_cost": "单位包装成本",
    "unit_other_cost": "单位其他成本",
    "unit_standard_cost": "单位到岸标准成本",
    "product_cost_cogs": "商品货款COGS",
    "first_mile_cogs": "头程海运COGS",
    "packaging_cogs": "包装COGS",
    "other_unit_cogs": "其他单位COGS",
    "internal_cogs": "到岸COGS合计",
...
METRIC_ZH: dict[str, str] = {
    ...
    "Packaging COGS": "包装COGS",
    "Other Unit COGS": "其他单位COGS",
    "Management Operating Profit": "经营利润",
    "Management Operating Margin": "经营利润率",
    "Settlement Close Profit": "Settlement结算口径利润",
    "SKU Cost Coverage": "SKU成本覆盖状态",
    "First-Mile Cost Included": "头程成本已计入",
    "Unknown Settlement Classification": "未知Settlement分类状态",
    "Bank Payout Reconciliation": "银行回款核对",
    "Settlement Revenue Bucket": "Settlement收入桶",
    "Settlement Reimbursement": "Settlement赔偿",
    "Settlement Liquidation Income": "Settlement清算收入",
    "Settlement Other": "Settlement其他",
    "Settlement Refund": "Settlement退款",
    "Settlement Promotion Discounts": "Settlement促销折扣",
    "Settlement Promotion Fees": "Settlement促销活动费",
    "Settlement FBA Fulfillment Fees": "Settlement FBA履约费",
    "Settlement FBA Storage Fees": "Settlement FBA仓储费",
    "Settlement Amazon Platform Fees": "Settlement亚马逊平台费",
    "Settlement Amazon Fee Refunds": "Settlement亚马逊费用返还",
    "Settlement Liquidation Fees": "Settlement清算费用",
    "Settlement Tax Passthrough": "Settlement税务代收代付",
    "Settlement Reconciliation Items": "Settlement对账项",
    "Settlement Net Excluding Posted Ads": "剔除Settlement广告后的净额",
    "Less Ads API Report-date Spend": "减：Ads API月度广告支出",
    "Contribution After Ads Before Landed COGS": "广告后、到岸成本前贡献",
    "Less Product Cost COGS": "减：商品货款成本",
    "Less First-Mile Freight COGS": "减：头程海运成本",
    "Less Packaging COGS": "减：包装成本",
    "Less Other Unit COGS": "减：其他单位成本",
